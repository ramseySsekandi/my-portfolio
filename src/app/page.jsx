...
const Homepage = () => {
  return (
    <div className='pb-4 h-full flex flex-col px-4 sm:px-8 md:px-12 lg:flex-row lg:px-20 xl:px-48'>
      {/* IMAGE CONTAINER */}
      ...
      <div className=" h-1/2 flex flex-col gap-2 lg:gap-8 items-center justify-center lg:h-full lg:w-1/2">
        ...
        <div className="w-full flex gap-4">
          <button className='p-4 rounded-lg ring ring-black bg-black text-white'>View My Works</button>
